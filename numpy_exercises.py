...
# Convert a from list -> numpy.ndarray
a_array = np.array(a)
print(type(a_array))
odds_in_a = a_array[a_array % 2 != 0]
...
sum_c_times_c_transposed = np.sum(c * c_transpose)
...
prod_c_times_c_transposed = np.prod(c * c_transpose)
